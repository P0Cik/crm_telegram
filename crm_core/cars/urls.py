...
router.register(r'model-groups', views.ModelGroupViewSet, basename='modelgroup')
...
router.register(r'import-profiles', views.ImportProfileViewSet, basename='importprofile')
...
def api_root(request, format=None):
    ...
    return Response({
        ...
        'model_groups': reverse('modelgroup-list', request=request, format=format),
        ...
        'import_profiles': reverse('importprofile-list', request=request, format=format),
    })
